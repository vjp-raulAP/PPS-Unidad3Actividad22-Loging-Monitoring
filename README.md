...
```bash
grep "172.18.0.1" /var/log/apache2/other_vhosts_access.log
```
...
**2. Actualizar los repositorios e instananolar Elasticsearch, Logstash y Kibana**
